...
<?php
	/**
 * Template Name: zaixainjiameng
 */
echo "在线加盟";
echo do_shortcode( '[contact-form-7 id="338" title="在线加盟"]' ); 
?>
...
<script type="text/javascript">
	...
	$(".url").attr("value",url);
	$(".wpcf7-form").attr("action","http://www.cnhkjt.com/wpc/wp-content/themes/hengkongguanwang/factory2.php");
    $('#send').click(function(){
         $.ajax({
             type: "POST",
